...
const { ink: INK, cream: CREAM, accent: ACCENT, font: FONT } = BRAND;
          ...
          <table role="presentation" width="620" cellpadding="0" cellspacing="0" style="width:620px;max-width:100%;background:${CREAM};border:2px solid ${INK};">
              ...
              <td style="background:${INK};padding:24px 36px;">
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td style="vertical-align:middle;padding-left:13px;font-family:${FONT};font-size:18px;font-weight:700;letter-spacing:0.01em;color:${ACCENT};text-transform:uppercase;">
                      Tendril School
                    </td>
            ...
            <tr>
              <td style="padding:40px 36px 0;">
                ...
                <h1 style="margin:22px 0 6px;font-family:${FONT};font-size:28px;font-weight:800;letter-spacing:-0.01em;color:${INK};">
                  ${escapeHtml(name)}
                </h1>
